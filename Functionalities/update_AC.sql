...
begin
    ...
    if flag2=0 then
        ...
        if flag1=1 then
            if Enter_0_For_Customer_1_For_Agent=0 then
                update customer set name=pl_name,address=pl_address where email_address=pl_email;
            else 
                update agent set name=pl_name,address=pl_address where email_address=pl_email;
            end if;
        else
